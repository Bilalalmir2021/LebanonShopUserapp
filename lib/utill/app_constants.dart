import 'package:flutter_sixvalley_ecommerce/common/enums/local_caches_type_enum.dart';
  ...
  class AppConstants {
  static const String appName = 'Lebanon Shop';
  static const String slogan = 'Online Shopping';
  ...
  static const String baseUrl = 'https://shop.talabatakawamer.site';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.ar, languageName: 'Arabic', countryCode: 'LB', languageCode: 'ar'),
  ];
